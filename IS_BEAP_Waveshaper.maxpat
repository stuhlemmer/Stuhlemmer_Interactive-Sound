...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 730.0, 435.0, 141.0, 116.0 ],
					"varname" : "bp.GL Scope",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 49.0, 519.0, 101.0, 116.0 ],
					"varname" : "bp.Scope",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 595.0, 200.0, 137.0, 116.0 ],
					"varname" : "bp.LFO[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 416.0, 200.0, 137.0, 116.0 ],
					"varname" : "bp.LFO",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 307.0, 269.0, 52.0, 47.0 ],
					"text" : "Fold\nWrap\nClip"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 49.0, 200.0, 254.420395000000013, 116.0 ],
					"varname" : "bp.Folder",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 284.0, 377.0, 372.0, 214.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 49.0, 392.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 410.0, 38.0, 578.0, 117.0 ],
					"varname" : "bp.Keyboard",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 49.0, 33.0, 314.0, 116.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-11::obj-12" : [ "Mute[3]", "Mute", 0 ],
			"obj-11::obj-20" : [ "Frequency[1]", "Freq", 0 ],
			"obj-12::obj-20" : [ "RangeSwitch", "RangeSwitch", 0 ],
			"obj-13::obj-51" : [ "Rate", "Rate", 0 ],
			"obj-13::obj-5::obj-2" : [ "pastebang[1]", "pastebang", 0 ],
			...
			"obj-7::obj-38" : [ "LoValueCV", "CV", 0 ],
			"obj-7::obj-4" : [ "bypass", "bypass", 0 ],
			"obj-7::obj-40" : [ "LoValue", "Low", 0 ],
			"obj-7::obj-45" : [ "mode", "mode", 0 ],
			"obj-7::obj-50" : [ "HiValueCV", "CV", 0 ],
			"obj-7::obj-52" : [ "HiValue", "High", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
